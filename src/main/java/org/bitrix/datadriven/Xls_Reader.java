...
public class Xls_Reader {
    ...
    public Xls_Reader(String path, String SheetName) {
        ...
        try {
            ...
            if (isSheetExist(SheetName)) {
                ...
                BitrixLogger.info("Sheet is present in the Xlxs file.");
            }
            fis.close();
        } catch (Exception e) {
        	BitrixLogger.info(" xlxs File does not found : ", e);
        }
    }
    ...
    public String getColumsData(int colNum, int rowNum) {
        ...
        try {
        	...
        	BitrixLogger.info("row does not fund for the index for cell data : ",
                    e);
        }
        return cellText;
    }
